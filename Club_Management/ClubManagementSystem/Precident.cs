    ...
    public partial class Precident : Form
    {
            ...
            var items = new[] { 
                  new{ Text = "Good", Value = "Good" },
                    new { Text = "Very Good", Value = "Very Good" },
                     new{ Text = "Excilent", Value = "Excilent" }
                };
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if(p.Rank == "Admin" || p.Rank == "Precident")
                {
        ...
        {
            PinfoDataContext con = new PinfoDataContext(@"Data Source=(LocalDB)\v11.0;AttachDbFilename=C:\Users\gadgets planet\Desktop\SalimProject\ClubManagementSystem\ClubDatabase.mdf;Integrated Security=True;Connect Timeout=30");
