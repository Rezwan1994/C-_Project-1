...
namespace ClubManagementSystem
{
    public partial class Form1 : Form
    {
        ...
        {
            SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\v11.0;AttachDbFilename=C:\Users\gadgets planet\Desktop\SalimProject\ClubManagementSystem\ClubDatabase.mdf;Integrated Security=True;Connect Timeout=30");
            con.Open();
            ...
            for (int i = 0; i < intIdt; i++)
            {
                ...
                try
                {
                    if ((Int32.Parse(t[0].ToString())) == Int32.Parse(textBox1.Text) && t[2].ToString() == textBox2.Text && t[3].ToString() == "Precident")
                    {
