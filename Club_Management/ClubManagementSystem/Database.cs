...
namespace ClubManagementSystem
{
    class Database
    {
        ...
        public Database()
        {
            ...
            con = new PinfoDataContext(@"Data Source=(LocalDB)\v11.0;AttachDbFilename=C:\Users\gadgets planet\Desktop\SalimProject\ClubManagementSystem\ClubDatabase.mdf;Integrated Security=True;Connect Timeout=30");
